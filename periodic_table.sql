...
CREATE TABLE public.types (
    ...
    type_id integer DEFAULT nextval('public.types_type_id_seq'::regclass) NOT NULL
);
...
--
-- Name: types_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE public.types_id_seq OWNER TO freecodecamp;

--
-- Name: types_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--
...
--
-- Name: types id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--
...
INSERT INTO public.types VALUES (6, 'metal', 1);
INSERT INTO public.types VALUES (7, 'metalloid', 2);
INSERT INTO public.types VALUES (8, 'nonmetal', 3);


--
-- Name: types_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--
...
SELECT pg_catalog.setval('public.types_type_id_seq', 1, true);
...
ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_type_id FOREIGN KEY (type_id) REFERENCES public.types(type_id) ON DELETE CASCADE;
